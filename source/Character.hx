...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'Ball':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/ball', 'shared');
				frames = tex;
			...
			case 'Ball_Confused':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/ball-confused', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'idle', 24);
				animation.addByPrefix('singUP', 'up', 24);
				animation.addByPrefix('singRIGHT', 'right', 24);
			...
			case 'noone':
				var tex = Paths.getSparrowAtlas('characters/noone', 'shared');
				frames = tex;
